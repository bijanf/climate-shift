...
def main():
    parser = argparse.ArgumentParser(description="Generate Instagram carousel for a glacier")
    parser.add_argument("--name", type=str, required=True, help="Glacier registry key")

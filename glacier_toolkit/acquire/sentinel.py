...
class CDSEClient:
    ...
    def _get_token(self):
        ...
        resp = requests.post(CDSE_AUTH_URL, data={
    ...
    def search(self, bbox, date_start, date_end, cloud_cover_max=20,
...
def download_sentinel2(bbox, date_start, date_end, output_dir=None,
                        cloud_cover_max=20, max_products=5):
